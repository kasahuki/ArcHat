<template>
  <div v-if="visible" class="user-detail-popup" :style="popupStyle">
    <div class="user-detail-content">
      ...
      <div class="user-details">
        ...
        <div class="detail-item">
          ...
          <span class="value">{{ group.announcement || '暂无公告…' }}</span>
        </div>
      </div>
      ...
      <div class="group-members">
        ...
        <div class="members-list">
          <div v-for="member in displayedMembers" :key="member.id" class="member-item">
            ...
            <span v-if="member.isOwner" class="member-role owner">群主</span>
            <span v-else-if="member.isAdmin" class="member-role admin">管理员</span>
          </div>
...
const emit = defineEmits(['update:visible', 'start-chat']);
